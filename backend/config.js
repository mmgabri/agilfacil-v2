...
const TABLE_USERS = process.env.TABLE_USERS || 'agilfacil_users'

module.exports = { PORT, CORS_OPTIONS, TABLE_BOARD, TABLE_ROOM, BOARD_INDEX_NAME_USER, REGION, ROOM_INDEX_NAME_USER, TABLE_CONNECTIONS, TABLE_USERS };